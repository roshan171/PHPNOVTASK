...
$mail = new PHPMailer();
$mail->IsSMTP();
$mail->Host = "127.0.0.1"; // Change "localhost" to "127.0.0.1"
$mail->SMTPAuth = true;
$mail->Username = "roshan@gmail.com"; // Enter your email here
$mail->Password = "yourpassword"; // Enter your password here
$mail->Port = 1025;
$mail->IsHTML(true);
$mail->From = "roshandhawde143@gmail.com";
$mail->FromName = "Roshan Dhawde";
// $mail->Sender = $fromserver; // Comment or remove this line
